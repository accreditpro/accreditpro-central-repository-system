...
export const financeTabConfigs: FinanceTabConfig[] = [
  {
    ...
    fields: [
      ...
      { key: 'approvedBy', label: 'Approved By', type: 'text' },
      {
        ...
        label: 'Status',
        type: 'select',
        options: ['Proposed', 'Approved', 'Revised', 'Frozen', 'Closed'],
      },
    ...
    sampleData: [
      ...
      },
      {
        ...
        approvedBy: 'Finance Committee',
        status: 'Revised',
        remarks: 'E-journal subscriptions added',
      },
      {
        financialYear: '2024-25',
        department: 'Administration',
        budgetHead: 'Administrative',
        allocatedAmount: 1200000,
        revisedAmount: 1200000,
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: 'Category',
        type: 'select',
        options: ['Academic', 'Non-Academic', 'Grants', 'Self-Generated', 'Endowment'],
      },
      ...
      { key: 'recurring', label: 'Recurring', type: 'select', options: ['Yes', 'No'] },
      {
        ...
        type: 'select',
        options: ['Pending', 'Verified', 'Audited'],
      },
      { key: 'remarks', label: 'Remarks', type: 'text' },
    ],
    sampleData: [
      {
        financialYear: '2024-25',
        revenueSource: 'Tuition Fees',
        category: 'Academic',
        amount: 45000000,
        receiptDate: '2024-07-15',
        sourceEntity: 'Students (All Programs)',
        referenceNumber: 'TF-2024-001',
        recurring: 'Yes',
        verificationStatus: 'Verified',
        remarks: 'Semester 1 collection',
      },
      {
        financialYear: '2024-25',
        revenueSource: 'Government Grants',
        category: 'Grants',
        amount: 12000000,
        receiptDate: '2024-06-01',
        sourceEntity: 'State Government',
        referenceNumber: 'GG-2024-045',
        recurring: 'Yes',
        verificationStatus: 'Audited',
        remarks: 'Annual grant',
      },
      {
        financialYear: '2024-25',
        revenueSource: 'Consultancy Income',
        category: 'Self-Generated',
        amount: 3500000,
        receiptDate: '2024-09-20',
        sourceEntity: 'Various Industries',
        referenceNumber: 'CI-2024-012',
        recurring: 'No',
        verificationStatus: 'Verified',
        remarks: 'Faculty consultancy',
      },
      {
        financialYear: '2024-25',
        revenueSource: 'Interest Income',
        category: 'Non-Academic',
        amount: 2800000,
        receiptDate: '2024-12-31',
        sourceEntity: 'Bank FD',
        referenceNumber: 'INT-2024-Q4',
        recurring: 'Yes',
        verificationStatus: 'Pending',
        remarks: 'FD interest accrued',
      },
    ],
  },
  {
    ...
    fields: [
      ...
      { key: 'invoiceNumber', label: 'Invoice/Voucher No.', type: 'text' },
      {
        ...
        label: 'Payment Mode',
        type: 'select',
        options: ['NEFT', 'RTGS', 'Cheque', 'Cash', 'DD', 'Online'],
      },
      ...
      { key: 'approvedBy', label: 'Approved By', type: 'text' },
      {
        ...
        label: 'Status',
        type: 'select',
        options: ['Pending', 'Processed', 'Paid', 'Rejected'],
      },
    ],
    sampleData: [
      {
        financialYear: '2024-25',
        expenditureHead: 'Salaries & Wages',
        department: 'All',
        description: 'Faculty salaries - October 2024',
        amount: 8500000,
        paymentDate: '2024-10-30',
        vendorPayee: 'Faculty Members',
      ...
      {
        financialYear: '2024-25',
        expenditureHead: 'Equipment Purchase',
        department: 'Computer Science',
        description: 'Server rack and networking equipment',
        amount: 450000,
        paymentDate: '2024-08-15',
        vendorPayee: 'TechSolutions Pvt Ltd',
        invoiceNumber: 'INV-TS-2024-089',
        paymentMode: 'NEFT',
        budgetHead: 'Equipment',
        approvedBy: 'Purchase Committee',
        status: 'Paid',
      },
      {
        financialYear: '2024-25',
        expenditureHead: 'Library Resources',
        department: 'Library',
        description: 'E-journal subscription renewal',
        amount: 350000,
        paymentDate: '2024-07-01',
        vendorPayee: 'Elsevier India',
        invoiceNumber: 'ELS-2024-IN-456',
        paymentMode: 'RTGS',
        budgetHead: 'Library',
      ...
      {
        financialYear: '2024-25',
        expenditureHead: 'Maintenance & Repairs',
        department: 'Administration',
        description: 'Annual building maintenance contract',
        amount: 1200000,
        paymentDate: '2024-05-01',
        vendorPayee: 'BuildCare Services',
        invoiceNumber: 'BC-AMC-2024',
        paymentMode: 'Cheque',
        budgetHead: 'Maintenance',
        approvedBy: 'Estate Officer',
        status: 'Processed',
      },
    ],
  },
  {
    ...
    fields: [
      ...
      { key: 'endDate', label: 'End Date', type: 'date' },
      {
        ...
        type: 'select',
        options: ['Submitted', 'Sanctioned', 'Ongoing', 'Completed', 'Extended', 'Terminated'],
      },
      {
    ...
    sampleData: [
      {
        ...
        principalInvestigator: 'Dr. Anand Verma',
        department: 'Computer Science',
        fundingAgency: 'DST',
        sanctionedAmount: 2500000,
        receivedAmount: 1800000,
        expendedAmount: 1500000,
        sanctionDate: '2023-06-15',
        startDate: '2023-08-01',
        endDate: '2026-07-31',
        projectStatus: 'Ongoing',
        utilizationCertificate: 'Yes',
        remarks: 'Year 2 in progress',
      },
      {
        projectTitle: 'Sustainable Construction Materials',
        principalInvestigator: 'Dr. Meera Patel',
        department: 'Civil Engineering',
        fundingAgency: 'AICTE',
        sanctionedAmount: 1800000,
        receivedAmount: 1800000,
        expendedAmount: 1650000,
      ...
      {
        projectTitle: 'Nano-material Synthesis for Solar Cells',
        principalInvestigator: 'Dr. Suresh Kumar',
        department: 'Physics',
        fundingAgency: 'CSIR',
        sanctionedAmount: 3200000,
        receivedAmount: 2400000,
        expendedAmount: 2100000,
        sanctionDate: '2023-01-10',
        startDate: '2023-03-01',
        endDate: '2026-02-28',
        projectStatus: 'Ongoing',
        utilizationCertificate: 'Pending',
        remarks: 'Equipment procurement delayed',
      },
      {
        projectTitle: 'Rural Healthcare IoT Network',
        principalInvestigator: 'Dr. Kavitha Rajan',
    ...
    sampleData: [
      {
        ...
        amountPerStudent: 25000,
        totalDisbursed: 1250000,
        disbursementDate: '2024-09-15',
        eligibilityCriteria: 'CGPA >= 9.0',
        selectionProcess: 'Academic performance',
        status: 'Disbursed',
        remarks: 'Annual merit scholarship',
      },
      {
        scholarshipName: 'SC/ST Scholarship (State Govt)',
        category: 'SC/ST',
        fundingSource: 'Government',
        academicYear: '2024-25',
        totalBeneficiaries: 120,
        amountPerStudent: 35000,
        totalDisbursed: 4200000,
        disbursementDate: '2024-10-01',
        eligibilityCriteria: 'SC/ST category, income < 2.5L',
        selectionProcess: 'Government norms',
        status: 'Disbursed',
        remarks: 'State scholarship scheme',
      },
      {
        scholarshipName: 'TechCorp STEM Scholarship',
        ...
        eligibilityCriteria: 'STEM students, CGPA >= 8.5',
        selectionProcess: 'Interview + Academic record',
        status: 'Disbursed',
        remarks: 'CSR initiative by TechCorp',
      },
      {
        ...
        amountPerStudent: 120000,
        totalDisbursed: 1800000,
        disbursementDate: '2024-07-01',
        eligibilityCriteria: 'PhD scholars with publications',
        selectionProcess: 'Research committee review',
        status: 'Partially Disbursed',
        remarks: 'Quarterly disbursement',
      },
    ],
  },
  {
    ...
    fields: [
      ...
      { key: 'utilizationDetails', label: 'Utilization Details', type: 'text' },
      {
        ...
        label: 'Status',
        type: 'select',
        options: ['Active', 'Matured', 'Partially Utilized', 'Fully Utilized', 'Dormant'],
      },
      { key: 'remarks', label: 'Remarks', type: 'text' },
    ],
    sampleData: [
      {
        donorName: 'Shri Ramesh Agarwal (Batch 1985)',
        donationType: 'Endowment',
        purpose: 'Merit Scholarship for ECE students',
        amount: 5000000,
        dateReceived: '2020-03-15',
        donorCategory: 'Alumni',
        taxExemption: 'Yes',
        corpusValue: 5800000,
        annualInterest: 420000,
        utilizationDetails: 'Annual scholarship to top 5 ECE students',
        status: 'Active',
        remarks: 'Perpetual endowment',
      },
      {
        donorName: 'InfoTech Solutions Ltd',
        donationType: 'Chair Professorship',
        purpose: 'Chair Professor in AI & ML',
        amount: 10000000,
        dateReceived: '2022-01-10',
        donorCategory: 'Corporate',
        taxExemption: 'Yes',
        corpusValue: 10500000,
        annualInterest: 750000,
        utilizationDetails: 'Salary supplement + research fund for Chair Professor',
        status: 'Active',
        remarks: '5-year renewable',
      },
      {
        donorName: 'Dr. Lakshmi Foundation',
        donationType: 'Corpus Fund',
        purpose: 'Girl child education support',
        amount: 3000000,
        dateReceived: '2019-08-20',
        donorCategory: 'Trust/Foundation',
        taxExemption: 'Yes',
        corpusValue: 3600000,
        annualInterest: 260000,
        utilizationDetails: 'Tuition fee waiver for 10 girl students annually',
        status: 'Active',
        remarks: 'Growing corpus',
      },
      {
        donorName: 'Parent Association 2023',
        donationType: 'One-time Donation',
        purpose: 'Auditorium renovation',
        amount: 1500000,
        dateReceived: '2023-12-05',
        donorCategory: 'Parent',
        taxExemption: 'Yes',
        corpusValue: 0,
        annualInterest: 0,
        utilizationDetails: 'Used for auditorium sound system upgrade',
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'complianceScore', label: 'Compliance Score (%)', type: 'percentage' },
      {
        ...
        label: 'Audit Opinion',
        type: 'select',
        options: ['Unqualified', 'Qualified', 'Adverse', 'Disclaimer', 'Pending'],
      },
      {
        key: 'status',
        label: 'Status',
        type: 'select',
        options: ['In Progress', 'Completed', 'Report Submitted', 'Action Taken', 'Closed'],
      },
    ...
    sampleData: [
      {
        ...
        auditPeriod: 'Apr 2023 - Mar 2024',
        auditDate: '2024-05-15',
        reportDate: '2024-06-30',
        totalObservations: 12,
        majorFindings: 2,
        resolvedObservations: 10,
        complianceScore: 92,
        auditOpinion: 'Unqualified',
        status: 'Closed',
        remarks: 'Clean audit report',
      },
      {
        auditType: 'Internal Audit',
        financialYear: '2024-25',
        auditorName: 'Internal Audit Cell',
        auditPeriod: 'Apr 2024 - Sep 2024',
        ...
        auditOpinion: 'Unqualified',
        status: 'Action Taken',
        remarks: 'Procurement process improvement needed',
      },
      {
        auditType: 'Tax Audit',
        financialYear: '2023-24',
        auditorName: 'M/s Patel Tax Consultants',
        auditPeriod: 'Apr 2023 - Mar 2024',
        ...
        auditOpinion: 'Unqualified',
        status: 'Closed',
        remarks: 'All TDS compliances met',
      },
      {
        auditType: 'CAG Audit',
        financialYear: '2022-23',
        auditorName: 'Comptroller & Auditor General',
        auditPeriod: 'Apr 2022 - Mar 2023',
        auditDate: '2023-11-10',
        reportDate: '2024-02-28',
        totalObservations: 18,
        majorFindings: 4,
        resolvedObservations: 14,
        complianceScore: 85,
        auditOpinion: 'Qualified',
        status: 'Action Taken',
        remarks: 'Asset register discrepancies noted',
      },
    ],
  },
  {
    ...
    fields: [
      ...
      { key: 'purpose', label: 'Purpose/Earmarked For', type: 'text' },
      {
        ...
        label: 'Status',
        type: 'select',
        options: ['Active', 'Matured', 'Redeemed', 'Renewed', 'Under Lien'],
      },
      { key: 'remarks', label: 'Remarks', type: 'text' },
    ],
    sampleData: [
      {
        ...
        description: 'Corpus Fund FD',
        institution: 'State Bank of India',
        accountNumber: 'FD-38291047562',
        investmentAmount: 25000000,
        currentValue: 27500000,
        interestRate: 7.5,
        maturityDate: '2026-03-31',
        startDate: '2023-04-01',
        annualIncome: 1875000,
        purpose: 'Corpus Fund - General',
        status: 'Active',
        remarks: '3-year FD, auto-renewal',
      },
      {
        assetType: 'Fixed Deposit',
        description: 'Endowment Fund FD',
        institution: 'HDFC Bank',
        accountNumber: 'FD-9827364510',
        investmentAmount: 15000000,
        currentValue: 16200000,
        interestRate: 7.25,
        maturityDate: '2025-09-30',
        startDate: '2022-10-01',
        annualIncome: 1087500,
        purpose: 'Endowment Scholarships',
        status: 'Active',
        remarks: 'Linked to scholarship disbursement',
      },
      {
        assetType: 'Mutual Fund',
        description: 'Debt Fund - Conservative',
        institution: 'ICICI Prudential AMC',
        accountNumber: 'MF-IP-2024-789',
        ...
        annualIncome: 410000,
        purpose: 'Reserve Fund Growth',
        status: 'Active',
        remarks: 'Low-risk debt fund',
      },
      {
        assetType: 'Government Securities',
        description: 'G-Sec 2028',
        institution: 'RBI',
        accountNumber: 'GSEC-2028-456',
        investmentAmount: 10000000,
        currentValue: 10300000,
        interestRate: 7.1,
        maturityDate: '2028-12-31',
        startDate: '2023-01-01',
        annualIncome: 710000,
        purpose: 'Long-term reserve',
        status: 'Active',
        remarks: 'Government guaranteed',
      },
    ],
  },
];
