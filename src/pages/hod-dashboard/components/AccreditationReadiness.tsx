...
import { ACADEMIC_YEARS, getHODYearData, AccreditationFrameworkData } from '../hod-configs';
...
export function AccreditationReadiness({ academicYear }: { academicYear: string }) {
  const accreditation = getHODYearData(academicYear).accreditation;

  // Previous academic year (used to show YoY movement).
  ...
  const previous = previousYear ? getHODYearData(previousYear).accreditation : undefined;
