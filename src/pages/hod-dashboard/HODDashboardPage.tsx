...
export default function HODDashboardPage() {
  ...
  const getPageDescription = () => {
    switch (activeView) {
      ...
      case 'approvals': return 'Manage pending submissions and forward approved data to IQAC';
  ...
  const renderContent = () => {
    switch (activeView) {
      ...
      case 'readiness': return <RepositoryReadiness />;
      case 'analytics': return <DepartmentAnalytics />;
