...
export const academicRepositoryTabs: RepositoryTabConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: 'academicRegulation',
        label: 'Academic Regulation',
        type: 'text',
        required: true,
        csvColumn: 'Academic Regulation',
      },
      {
        key: 'totalCredits',
        label: 'Total Credits',
        type: 'number',
        required: true,
        csvColumn: 'Total Credits',
      },
      {
        key: 'openElectives',
        label: 'Open Electives Available',
        type: 'number',
        required: true,
        csvColumn: 'Open Electives Available',
      },
      {
        key: 'professionalElectives',
        label: 'Professional Electives Available',
        type: 'number',
        required: true,
        csvColumn: 'Professional Electives Available',
      },
      {
        key: 'vacAvailable',
        label: 'Value Added Courses Available',
        type: 'number',
        required: true,
        csvColumn: 'Value Added Courses Available',
      },
      {
        key: 'internshipIncluded',
        label: 'Internship Included',
        type: 'boolean',
        required: true,
        csvColumn: 'Internship Included',
      },
      {
        key: 'projectWorkIncluded',
        label: 'Project Work Included',
        type: 'boolean',
        required: true,
        csvColumn: 'Project Work Included',
      },
      {
        key: 'industryCoursesIncluded',
        label: 'Industry Courses Included',
        type: 'boolean',
        required: true,
        csvColumn: 'Industry Courses Included',
      },
      {
        key: 'revisionDate',
        label: 'Revision Date',
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'endDate', label: 'End Date', type: 'date', required: true, csvColumn: 'End Date' },
      {
        ...
        type: 'number',
        required: true,
        csvColumn: 'Instructional Days',
      },
      {
        key: 'midExamDates',
        label: 'Mid Exam Start Date',
        type: 'date',
        required: true,
        csvColumn: 'Mid Exam Start Date',
      },
      {
        key: 'endExamDates',
        label: 'End Exam Start Date',
        type: 'date',
        required: true,
        csvColumn: 'End Exam Start Date',
      },
    ],
...
export const uploadHistoryData: UploadHistoryRecord[] = [
  {
    id: '1',
    fileName: 'programs_cse_2025.csv',
    tab: 'Programs',
...
export const evidenceDocuments: EvidenceDocument[] = [
  {
    id: '1',
    name: 'AICTE Approval Letter 2025-26.pdf',
    category: 'Programs',
    version: 'v1.0',
    uploadedBy: 'Dr. Anita Sharma',
  ...
  {
    id: '3',
    name: 'Curriculum Structure R2022.xlsx',
    category: 'Curriculum',
    version: 'v2.1',
    uploadedBy: 'Prof. Meera Patel',
...
export const mockValidationResult: ValidationResult = {
  ...
  errors: [
    ...
    },
    {
      ...
      column: 'Status',
      value: 'Inactive',
      message: 'Unusual status value detected',
      severity: 'warning',
    },
    {
      row: 35,
