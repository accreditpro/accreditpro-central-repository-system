...
export const InstitutionFilters = ({ filters, onFilterChange }: InstitutionFiltersProps) => {
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <Select
            ...
            onValueChange={val =>
              onFilterChange({ ...filters, category: val as IFilters['category'] })
            }
          >
          ...
          <Select
            ...
            onValueChange={val =>
              onFilterChange({
                ...filters,
                repositoryCompletion: val as IFilters['repositoryCompletion'],
              })
            }
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="below-50" className="text-xs">
                Below 50%
              </SelectItem>
              <SelectItem value="50-75" className="text-xs">
                50% - 75%
              </SelectItem>
              <SelectItem value="above-75" className="text-xs">
                Above 75%
              </SelectItem>
            </SelectContent>
          </Select>
