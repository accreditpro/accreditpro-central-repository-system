...
import {
  Building2, MapPin, GraduationCap, Calendar, UserCog, Shield, User,
} from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg border p-5 space-y-5 bg-card">
        ...
        {/* Academic Config */}
        <Section icon={<GraduationCap className="h-4 w-4 text-purple-500" />} title="Academic Configuration">
          <div className="flex items-start gap-2">
        ...
        <Section icon={<UserCog className="h-4 w-4 text-red-500" />} title="Institution Admin">
          ...
          <Field label="Password" value={data.admin.autoGeneratePassword ? 'Auto-generated' : 'Manual'} />
        </Section>
        ...
        <Section icon={<Shield className="h-4 w-4 text-cyan-500" />} title="IQAC Coordinator">
          ...
          <Field label="Password" value={data.iqacCoordinator.autoGeneratePassword ? 'Auto-generated' : 'Manual'} />
        </Section>
        ...
        <Section icon={<User className="h-4 w-4 text-indigo-500" />} title="Principal">
          ...
          <Field label="Password" value={data.principal.autoGeneratePassword ? 'Auto-generated' : 'Manual'} />
        </Section>
      </div>
    </div>
  );
