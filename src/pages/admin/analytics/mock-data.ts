...
export const recentActivityData: RecentActivityItem[] = [
  {
    id: '1',
    action: 'Uploaded NAAC SSR Document',
  ...
  {
    id: '3',
    action: 'Updated faculty records',
  ...
  {
    id: '4',
    action: 'Uploaded placement data',
  ...
  {
    id: '7',
    action: 'Updated research publications',
    user: 'Dr. Kavitha Rajan',
  ...
  {
    id: '9',
    action: 'Uploaded infrastructure report',
