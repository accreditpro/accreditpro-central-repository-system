...
export const AlumniDetailTab = () => {
  ...
  const openDeleteDialog = (alumni: AlumniDetailResponse) => {
    setSelectedAlumni(alumni);
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                size="icon"
                className="h-7 w-7"
                onClick={() => fetchAlumni(page, submittedSearch)}
                disabled={loading}
              >
            ...
            <div>
              ...
              <CardDescription className="text-xs">
                {loading
                  ? 'Loading...'
                  : data
                    ? `Page ${data.page + 1} of ${totalPages} (${data.totalElements} records)`
                    : ''}
              </CardDescription>
            </div>
                  ...
                  data?.content.map((alumni, index) => (
                    <TableRow key={alumni.id} className="hover:bg-muted/20">
                      ...
                      <TableCell className="text-[10px] p-1.5">
                        <Badge
                          variant="secondary"
                          className={cn('text-[9px]', getStatusBadge(alumni.alumniStatus))}
                        >
                          {alumni.alumniStatus}
                        </Badge>
                      </TableCell>
                      <TableCell className="text-center p-1.5">
                        <div className="flex items-center justify-center gap-0">
                          ...
                          <Button
                            ...
                            size="icon"
                            className="h-5 w-5"
                            onClick={() => openDeleteDialog(alumni)}
                            title="Delete"
                          >
        ...
        <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription className="text-xs">
              Fill in the details. Required fields marked with *.
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="grid gap-1.5">
                ...
                <Input
                  ...
                  onChange={e =>
                    setFormData(prev => ({ ...prev, linkedinProfile: e.target.value }))
                  }
                />
              </div>
              <div className="grid gap-1.5">
                ...
                <Select
                  value={formData.alumniStatus || 'Active'}
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent className="max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription className="text-xs">
              Delete <strong>{selectedAlumni?.alumniName}</strong> (ID: {selectedAlumni?.alumniId})?
