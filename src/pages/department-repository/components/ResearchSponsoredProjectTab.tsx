                  ...
                  data?.content.map((project, index) => (
                    <TableRow key={project.id} className="hover:bg-muted/20">
                      ...
                      <TableCell className="text-[10px] p-1.5">
                        <Badge
                          variant="secondary"
                          className={cn('text-[9px]', getStatusBadge(project.projectStatus))}
                        >
          ...
          <div className="grid gap-3 py-3">
            <div className="grid gap-1.5">
              ...
              <Input
                ...
                placeholder="e.g. IoT-based Smart Agriculture"
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="grid gap-1.5">
                ...
                <Input
                  ...
                  onChange={e =>
                    setFormData(prev => ({ ...prev, sponsorOrganization: e.target.value }))
                  }
                />
              </div>
              <div className="grid gap-1.5">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="grid gap-1.5">
                ...
                <Input
                  ...
                  onChange={e =>
                    setFormData(prev => ({ ...prev, projectValue: Number(e.target.value) }))
                  }
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="grid gap-1.5">
                ...
                <Select
                  ...
                  onValueChange={v =>
                    setFormData(prev => ({ ...prev, projectStatus: v || undefined }))
                  }
                >
              ...
              <div className="grid gap-1.5">
                ...
                <Input
                  className="h-9 text-xs"
                  placeholder="e.g. Prototype developed"
        ...
        <DialogContent className="max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription className="text-xs">
              ...
              <strong>&ldquo;{selectedProject?.projectTitle}&rdquo;</strong>? This action cannot be
              undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
