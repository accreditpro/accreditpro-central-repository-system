...
export default function Step7_RevisedCOPOMapping({ outcomes, mappings, coverage, data, onUpdate, onSave, onNext, onPrev, completionPercentage }: Step7Props) {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">AI regenerates the mapping after incorporating gap analysis recommendations</p>
        </div>
      ...
      {!data ? (
        <div className="flex flex-col items-center justify-center py-12">
          ...
          <p className="text-xs text-muted-foreground mb-6 text-center max-w-md">
            After accepting activities from gap analysis, AI will regenerate the CO-PO matrix with improved coverage
          </p>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-4">
          ...
          <Card className="border-emerald-500/30 bg-gradient-to-r from-emerald-500/5 to-green-500/5">
            <CardContent className="p-4 flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-semibold text-emerald-700 dark:text-emerald-400">Improvement Achieved</p>
                <p className="text-2xl font-bold text-emerald-600">+{data.improvementPercentage}%</p>
                <p className="text-xs text-muted-foreground">Overall PO coverage improvement after gap analysis recommendations</p>
              </div>
            </CardContent>
          </Card>
            ...
            <Card className="border-emerald-500/20 bg-emerald-500/5">
              <CardHeader className="pb-2">
                <CardTitle className="text-xs font-semibold flex items-center gap-2">
                  ...
                  <Badge variant="outline" className="text-[9px] text-emerald-600">Improved</Badge>
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-1.5">
          ...
          <Card className="border-amber-500/20 bg-amber-500/5">
            <CardHeader className="pb-2">
              <CardTitle className="text-xs font-semibold text-amber-600">Mapping Differences</CardTitle>
            </CardHeader>
            <CardContent>
                          ...
                          <td key={po.id} className="p-1.5 text-center relative">
                            <div
                              className={cn(
                                ...
                                isReduced && 'ring-2 ring-amber-400/50 ring-offset-1 ring-offset-background',
                              )}
