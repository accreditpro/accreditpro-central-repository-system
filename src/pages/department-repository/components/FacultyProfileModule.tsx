...
export const FacultyProfileModule = ({ department, academicYear }: FacultyProfileModuleProps) => {
  ...
  const handleImportUploaded = useCallback(async () => {
    ...
    const rows = validRecords.map(r =>
      [
        ...
        (r.status || 'Active').toUpperCase().replace(/\s+/g, '_'),
        r.dateOfLeaving,
        selectedYear,
      ]
    ...
    try {
      setIsLoading(true);
      await facultyRepositoryService.uploadFacultyProfilesCSV(
        departmentId,
        fileToUpload,
        selectedYear
      );
  ...
  const handleSaveRecord = useCallback(async () => {
    ...
    try {
      ...
      if (editingRecord) {
        await facultyRepositoryService.updateFacultyProfile(
          editingRecord.id,
          selectedYear,
          departmentId,
          payload
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Manage faculty personal details — EMP Code, Name, PAN, AADHAR, Contact, Designation,
              Status
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-wrap items-center gap-3">
        <div className="relative flex-1 min-w-[200px] max-w-sm">
          ...
          <Input
            placeholder="Search by EMP code, name, email..."
            value={searchQuery}
        ...
        <Select value={filterStatus} onValueChange={setFilterStatus}>
          ...
          <SelectContent>
            ...
            {STATUSES.map(s => (
              <SelectItem key={s} value={s.toUpperCase().replace(/[-\s]+/g, '_')}>
                {s}
              </SelectItem>
            ))}
          </SelectContent>
        ...
        <DialogContent className="sm:max-w-xl">
          <DialogHeader>
            <DialogTitle className="text-base">
              {editingRecord ? 'Edit Faculty Profile' : 'Add Faculty Profile'}
            </DialogTitle>
          </DialogHeader>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    {GENDERS.map(g => (
                      <SelectItem key={g} value={g.toUpperCase().replace(/[-\s]+/g, '_')}>
                        {g}
                      </SelectItem>
                    ))}
                  </SelectContent>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={v => setFormData({ ...formData, currentDesignation: v })}
                >
                  <SelectTrigger className="mt-1 h-9 text-sm">
                    <SelectValue placeholder="Select" />
                  </SelectTrigger>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={!formData.empCode || !formData.name || isLoading}
            >
                        ...
                        <TableCell className="text-center">
                          {r.validationStatus === 'valid' ? (
                            ...
                            <div className="flex items-center gap-1 justify-center">
                              ...
                              <span className="text-[9px] text-red-600">{r.errors?.[0]}</span>
                            </div>
                          )}
                        </TableCell>
                      </TableRow>
