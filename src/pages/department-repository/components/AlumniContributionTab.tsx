...
export const AlumniContributionTab = () => {
  ...
  const handleDownloadTemplate = () => {
    ...
    link.href = url;
    link.download = 'alumni_contributions_template.csv';
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Choose an alumni to view their contribution records.
            </p>
          </CardContent>
        </Card>
      ) : (
                        ...
                        <TableRow key={rec.id} className="hover:bg-muted/20">
                          ...
                          <TableCell className="text-[10px] p-1.5">
                            <Badge variant="outline" className="text-[9px]">
                              {rec.contributionType || '-'}
                            </Badge>
                          </TableCell>
                          <TableCell className="text-[10px] p-1.5 font-medium">
                            {rec.contributionTitle}
                          </TableCell>
                          <TableCell className="text-[10px] p-1.5 font-mono">
                            {formatAmount(rec.contributionValue)}
                          </TableCell>
                          <TableCell className="text-[10px] p-1.5 font-mono">
                            {rec.contributionDate}
                          </TableCell>
                          <TableCell className="text-[10px] p-1.5">
                            {rec.beneficiaryDepartment || '-'}
                          </TableCell>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="grid gap-1.5">
                ...
                <Select
                  ...
                  onValueChange={v =>
                    setFormData(p => ({ ...p, contributionType: v || undefined }))
                  }
                >
                  <SelectTrigger className="h-9 text-xs">
              ...
              <div className="grid gap-1.5">
                ...
                <Input
                  ...
                  placeholder="e.g. Merit Scholarship Fund"
              ...
              <div className="grid gap-1.5">
                ...
                <Input
                  ...
                  onChange={e =>
                    setFormData(p => ({
                      ...p,
                      contributionValue: e.target.value ? Number(e.target.value) : 0,
                    }))
                  }
                />
              </div>
            ...
            <div className="grid grid-cols-1 gap-3">
              <div className="grid gap-1.5">
                ...
                <Select
                  ...
                  onValueChange={v =>
                    setFormData(p => ({ ...p, beneficiaryDepartment: v || undefined }))
                  }
                >
                  <SelectTrigger className="h-9 text-xs">
