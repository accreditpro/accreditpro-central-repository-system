...
import { CheckCircle2, Clock, XCircle, Shield, AlertTriangle } from 'lucide-react';
    ...
    <div className="space-y-5">
              ...
              <CardContent className="p-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className={cn('text-lg font-bold', stat.color.split(' ')[0])}>
                      {stat.value}
                    </p>
                  </div>
                </div>
      ...
      <Card className="border-border/50">
        <CardHeader className="pb-3">
          ...
          <CardDescription className="text-xs">
            Verification status breakdown by repository
          </CardDescription>
        </CardHeader>
            ...
            return (
              <div key={config.id} className="p-4 rounded-xl border border-border/50">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <Badge
                      ...
                      className={cn(
                        'text-[9px]',
                        metrics.verificationPercent >= 80
                          ? 'bg-emerald-500/10 text-emerald-600'
                          : metrics.verificationPercent >= 60
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <span className="text-[10px] text-muted-foreground w-28">
                      Data Completeness
                    </span>
      ...
      <Card className="border-border/50">
        <CardHeader className="pb-3">
          ...
          <CardDescription className="text-xs">
            Records pending verification or with issues
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-2">
