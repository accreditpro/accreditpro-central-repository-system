...
export const StudentProfileTab = () => {
  ...
  const handleCreate = async () => {
    ...
    if (
      ...
      toast.error(
        'Registration Number, Student ID, Roll Number, Student Name, and Program are required'
      );
      return;
    }
    setSaving(true);
                  ...
                  data?.content.map((student, index) => (
                    <TableRow key={student.id} className="hover:bg-muted/20">
                      ...
                      <TableCell className="text-[10px] p-1.5">
                        <Badge
                          variant="secondary"
                          className={cn('text-[9px]', getStatusBadgeStyle(student.studentStatus))}
                        >
          ...
          <div className="grid gap-3 py-3">
              ...
              <div className="grid gap-1.5">
                ...
                <Input
                  ...
                  onChange={e =>
                    setFormData(prev => ({
                      ...prev,
                      programOfferingId: parseInt(e.target.value, 10) || 0,
                    }))
                  }
                />
              </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="grid gap-1.5">
                ...
                <Input
                  ...
                  onChange={e =>
                    setFormData(prev => ({
                      ...prev,
                      currentSemester: e.target.value ? parseInt(e.target.value, 10) : undefined,
                    }))
                  }
                />
              </div>
              <div className="grid gap-1.5">
                ...
                <Select
                  value={formData.studentStatus || 'Active'}
                  onValueChange={v => setFormData(prev => ({ ...prev, studentStatus: v }))}
                >
                  <SelectTrigger className="h-9 text-xs">
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="Discontinued" className="text-xs">
                      Discontinued
                    </SelectItem>
                  </SelectContent>
                </Select>
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent className="max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription className="text-xs">
              Are you sure you want to delete <strong>{selectedStudent?.studentName}</strong> (ID:{' '}
