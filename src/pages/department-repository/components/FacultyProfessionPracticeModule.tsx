    ...
    <div className="space-y-6">
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
          ...
          <Card className="border-border/50"><CardContent className="p-3"><p className="text-[10px] text-muted-foreground uppercase tracking-wider font-medium">Total Records</p><p className="text-sm font-semibold mt-0.5 text-amber-600">{totalForYear}</p></CardContent></Card>
        </div>
      </div>
